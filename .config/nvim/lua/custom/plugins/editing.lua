return {
  ...
  },
  {
    ...
    opts = {
      ...
      -- Default fuzzy implementation: prefer Rust with warning, falls back to Lua if Rust binary not available
      fuzzy = {
        implementation = 'prefer_rust_with_warning',
        prebuilt_binaries = {
          download = true,
          -- Force a specific version to ensure binary compatibility
